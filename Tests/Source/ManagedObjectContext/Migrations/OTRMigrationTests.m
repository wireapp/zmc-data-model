...
- (void)testThatItPerformsMigrationFrom_2_25_0_ToCurrentModelVersion {
    ...
    [self performMockingStoreURLWithVersion:@"2.25.0" block:^(NSURL *sharedContainer, NSUUID *accountId) {
        ...
        NSURL *storeURL = [StorageStack accountFolderWithAccountIdentifier:accountId applicationContainer:sharedContainer];
...
- (NSManagedObjectContext *)checkThatItCreatesSyncContextAndPreparesLocalStoreWithAccountIdentifier:(NSUUID *)accountID inSharedContainer:(NSURL *)containerURL
{
    ...
    [StorageStack.shared createManagedObjectContextDirectoryForAccountIdentifier:accountID
...
- (NSArray *)testBundleDataBaseURLsWithSuffix:(NSString *)suffix
{
    ...
    for (NSString *extension in [DatabaseBaseTest databaseFileExtensions]) {
