...
extension ClientMessageTests_OTR {
    ...
    func testThatCreatesEncryptedDataAndAddsItToGenericMessageAsBlob() {
        self.syncMOC.performGroupedBlockAndWait {
            ...
            // when
            guard let dataAndStrategy = textMessage.encryptedPayload(for: conversation, externalData: nil)
            else { return XCTFail() }
    ...
    func testThatCorruptedClientsReceiveBogusPayload() {
        self.syncMOC.performGroupedBlockAndWait {
            ...
            //when
            guard let dataAndStrategy = message.encryptedPayload() else {
                XCTFail()
                return
            }
    ...
    func testThatItCreatesPayloadDataForTextMessage() {
        self.syncMOC.performGroupedBlockAndWait {
            ...
            //when
            guard let payloadAndStrategy = message.encryptedPayload() else {
                XCTFail()
                return
            }
    ...
    func testThatItCreatesPayloadDataForEphemeralTextMessage_Group() {
        self.syncMOC.performGroupedBlockAndWait {
            ...
            //when
            guard let payloadAndStrategy = message.encryptedPayload() else { return XCTFail() }
    ...
    func testThatItCreatesPayloadDataForDeletionOfEphemeralTextMessage_Group() {
        ...
        self.syncMOC.performGroupedBlockAndWait {
            ...
            // when
            guard let payloadAndStrategy = sut?.encryptedPayload() else { return XCTFail() }
...
extension ClientMessageTests_OTR {
    ...
    func testThatItCreatesPayloadDataForConfirmationMessage() {
        self.syncMOC.performGroupedBlockAndWait {
            ...
            //when
            guard let payloadAndStrategy = confirmationMessage?.encryptedPayload()
            else { return XCTFail()}
    ...
    func testThatItCreatesPayloadForConfimationMessageWhenOriginalHasSender() {
        syncMOC.performGroupedBlockAndWait {
            ...
            //when
            guard let _ = confirmationMessage?.encryptedPayload()
                else { return XCTFail()}
        }
    }
