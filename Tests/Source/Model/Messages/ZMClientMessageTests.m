...
- (void)testThatItCreatesClientMessagesFromUpdateEvent
{
    ...
    NSUUID *nonce = [NSUUID createUUID];
    ZMGenericMessage *message = [ZMGenericMessage messageWithContent:[ZMText textWith:self.name mentions:@[] linkPreviews:@[] quote:nil] nonce:nonce];
...
- (void)testThatItDoesNotCreateOTRMessageIfItsIdentifierIsInvalid
{
    ...
    NSString *senderClientID = [NSString createAlphanumericalString];
    NSUUID *nonce = [NSUUID createUUID];
    ZMGenericMessage *prototype = [ZMGenericMessage messageWithContent:[ZMText textWith:self.name mentions:@[] linkPreviews:@[] quote:nil] nonce:nonce];
...
- (void)testThatItIgnoresUpdates_OnAnAlreadyExistingClientMessageWithoutASenderClientID
{
    ...
    ZMClientMessage *existingMessage = [[ZMClientMessage alloc] initWithNonce:nonce managedObjectContext:self.uiMOC];
    ZMGenericMessage *message = [ZMGenericMessage messageWithContent:[ZMText textWith:initialText mentions:@[] linkPreviews:@[] quote:nil] nonce:nonce];
    [existingMessage addData:message.data];
    existingMessage.visibleInConversation = conversation;
    existingMessage.sender = self.selfUser;
    
    ZMGenericMessage *modifiedMessage =     [ZMGenericMessage messageWithContent:[ZMText textWith:modifiedText mentions:@[] linkPreviews:@[] quote:nil] nonce:nonce];
...
- (void)testThatItIgnoresUpdates_OnAnAlreadyExistingClientMessageWhichDoesntContainLinkPreviewUpdate
{
    ...
    ZMClientMessage *existingMessage = [[ZMClientMessage alloc] initWithNonce:nonce managedObjectContext:self.uiMOC];
    ZMGenericMessage *message =     [ZMGenericMessage messageWithContent:[ZMText textWith:initialText mentions:@[] linkPreviews:@[] quote:nil] nonce:NSUUID.createUUID];
    [existingMessage addData:message.data];
    existingMessage.visibleInConversation = conversation;
    existingMessage.sender = self.selfUser;
    existingMessage.senderClientID = selfClient.remoteIdentifier;
...
- (void)testThatItIgnoresUpdates_OnAnAlreadyExistingClientMessageWhichContainLinkPreviewUpdateButModifiedText
{
    ...
    ZMGenericMessage *modifiedMessage = [ZMGenericMessage messageWithContent:[ZMText textWith:modifiedText mentions:@[] linkPreviews:@[linkPreview] quote:nil] nonce:nonce];
