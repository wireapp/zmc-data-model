...
extension AppLockControllerTest {
    func testItMigratesIsActiveStateFromTheKeychainToTheMOC() {
        ...
        ZMKeychain.setData(data, forAccount: AppLockController.FeatureName.lockApp.rawValue)
        
        AppLockController.migrateIsApplockActiveState(in: uiMOC)
    ...
    func testItDoesNotMigrateIsActiveStateFromTheKeychainToTheMOC_IfKeychainIsEmpty() {
        ...
        //when
        ZMKeychain.deleteAllKeychainItems(withAccountName: AppLockController.FeatureName.lockApp.rawValue)
        AppLockController.migrateIsApplockActiveState(in: uiMOC)
