                                                ...
                                                sequence:(NSNumber *)sequence
{
    ...
    if (othersAreJoined) {
        if (conversation.conversationType == ZMConversationTypeGroup) {
            [joinedUsers addObjectsFromArray:conversation.lastServerSyncedActiveParticipants.allObjects];
        } else {
    ...
    if (otherIsSendingVideo) {
        if (conversation.conversationType == ZMConversationTypeGroup) {
            [usersSendingVideo addObjectsFromArray:conversation.lastServerSyncedActiveParticipants.allObjects];
        } else {
