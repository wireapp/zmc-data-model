...
class PasscodeKeychainItemMigration: ModelObjectsTests {
    ...
    func testThatItMigratesAPasscode() {
        ...
        try? Keychain.updateItem(PasscodeKeychainItem.Deprecated_PasscodeKeychainItem.passcode, value: data)
        
        PasscodeKeychainItem.migratePasscode(in: uiMOC)
