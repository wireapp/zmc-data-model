...
extension ZMConversation : ObjectInSnapshot {
    ...
    public var observableKeys : [String] {
        var keys = ["messages", "lastModifiedDate", "isArchived", "conversationListIndicator", "isSilenced", "securityLevel", "displayName", "estimatedUnreadCount", "clearedTimeStamp"]
...
open class GeneralConversationChangeInfo : ObjectChangeInfo {
    ...
    fileprivate var keysForConversationChangeInfo : Set<String> {
        return Set(arrayLiteral: "messages", "lastModifiedDate", "isArchived", "conversationListIndicator", "isSilenced", "otherActiveParticipants", "isSelfAnActiveMember", "displayName", "relatedConnectionState", "estimatedUnreadCount", "clearedTimeStamp", "securityLevel")
    }
