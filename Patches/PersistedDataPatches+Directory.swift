...
extension PersistedDataPatch {
    ...
    static let allPatchesToApply = [
        ...
        PersistedDataPatch(version: "233.3.0", block: InvalidConnectionRemoval.removeInvalid),
        PersistedDataPatch(version: "233.3.0", block: TransferApplockKeychain.migrateKeychainItems)
    ]
